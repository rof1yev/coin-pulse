...
import { useCoinGeckoWebSocket } from "@/hooks/use-coingecko-websocket";
...
const LiveDataWrapper = ({
  ...
  const tradeColumns: DataTableColumn<Trade>[] = [
    {
      ...
      cell: (trade: Trade) => (trade.price ? formatCurrency(trade.price) : "-"),
    },
    {
      header: "Amount",
    ...
    },
    {
      ...
      cell: (trade: Trade) => (trade.value ? formatCurrency(trade.value) : "-"),
    },
    {
      header: "Buy/Sell",
  ...
  return (
    <section id="live-data-wrapper">
      ...
      {trades.length > 0 && <Separator className="divider" />}
